...
- **`lib/gradioAdapter.ts`** — Updated to use native full-image inpainting, with optimized `applyLipSafeMaskCleanup` and dynamic coverage thresholds. Passed the adapted mask to the inpainting functions.
...
- **`context/decisions.md`** — Updated to document ADR-011.
